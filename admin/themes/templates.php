                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li>
                                <a href="<?php echo web_root; ?>admin/modules/galery/index.php"><i class="menu-icon icon-bold"></i> Galery </a></li>
                                <li><a href="<?php echo web_root; ?>admin/modules/modstudent/index.php"><i class="menu-icon icon-bold"></i> Manage Students </a></li>
                                <li><a href="<?php echo web_root; ?>admin/modules/user/index.php"><i class="menu-icon icon-book"></i>Manage Users </a>
